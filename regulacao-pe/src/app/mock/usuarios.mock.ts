...
export const USUARIOS_MOCK: Usuario[] = [
  ...
  { id: 'usr-ue', nome: 'Larissa Farias', email: 'larissa.farias@ue.pe.gov.br', perfil: 'UnidadeExecutante', vinculoNome: 'Hospital Regional Caruaru', vinculoId: 'ue-017', avatarIniciais: 'LF' },
];
